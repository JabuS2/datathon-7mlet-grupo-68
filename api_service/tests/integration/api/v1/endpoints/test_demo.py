...
async def test_onboarding_creates_demo_profile_and_decides(client, seeded):
    payload = {
        "email": "visitante@demo.com", "password": "segredo123",
        "idade": 30, "segmento": "02 - VAREJO",
    }
    ...
    decide = await client.post("/decide", json={"codCliente": cliente["codCliente"], "channel": "app"})
...
async def test_onboarding_duplicate_email_conflicts(client, seeded):
    payload = {
        "email": "dup@demo.com", "password": "segredo123",
        "idade": 40, "segmento": "02 - VAREJO",
    }
