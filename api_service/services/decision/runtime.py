...
A definição estática dos braços vem do `offer_catalog.json` (fonte de verdade), e as
estatísticas de contexto (média/desvio, distribuição de renda) são ajustadas do
