...
from services.bandit.dependencies import get_governance, get_service
...
async def register_policy(body: PoliticaCreate, gov: GovernanceService = Depends(get_governance)):
...
async def start_cycle(body: RetrainCycleCreate, gov: GovernanceService = Depends(get_governance)):
